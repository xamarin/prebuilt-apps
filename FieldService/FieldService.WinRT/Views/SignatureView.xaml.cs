...
namespace Xamarin.Controls
{
	public partial class SignatureView : UserControl
	{
		...
		public WriteableBitmap GetImage (Color strokeColor, Color fillColor, Size size, float scale, bool shouldCrop = true)
		{
			...
			if (shouldCrop && Points.Count () > 0) {
				...
				double scaleX = croppedRectangle.Width / ActualWidth;
				double scaleY = croppedRectangle.Height / ActualHeight;
